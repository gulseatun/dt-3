...
# Reached kararı için KÖR NOKTA korumalı çok daha güvenli eşikler
REACH_DISTANCE = 0.12  
REACH_XERR = 0.15
...
class AutonomousNavigator:
    ...
    def process_detections(self, frame, corners, ids):
        ...
        # DİKKAT: Eski kodda burada olan "last_seen_time" sıfırlaması kilitlenmeye yol açtığı için kalıcı olarak silindi.

    # ---------------------------------------------------------
    # AKILLI YÖN BULMA (Vektörel Geometri)
    # ---------------------------------------------------------
